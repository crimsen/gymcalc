 ...
 ******************************************************************************/
package de.gymcalc.editor.renderer;
...
public class MultiReferenceSwtRenderer extends AbstractControlSWTRenderer<VControl> {
	...
	private static final String ICON_ADD_EXISTING = "icons/sample.gif"; //$NON-NLS-1$
	private static final String ICON_ADD_NEW = "icons/add.png"; //$NON-NLS-1$
