 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class EnterJuristAction extends CommandAction {

	public EnterJuristAction( ) {
	}
	...
	protected Command createActionCommand(EditingDomain editingDomain, Collection<?> collection) {
		Command retVal = EnterJuristCommand.create(editingDomain, collection );
		return retVal;
	}
	...
	public void run(IAction action) {
        ...
        if (result == Window.OK) {
        	EnterJuristCommand c = (EnterJuristCommand) this.command;
