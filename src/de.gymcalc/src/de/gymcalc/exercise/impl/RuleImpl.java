 ...
 * <ul>
 *   <li>{@link de.gymcalc.exercise.impl.RuleImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RuleImpl extends EObjectImpl implements Rule {
	...
	protected EClass eStaticClass() {
		return ExercisePackage.Literals.RULE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExercisePackage.RULE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExercisePackage.RULE__NAME:
				return getName();
		}
