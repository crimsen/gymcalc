...
public class AddressTypeImpl extends EObjectImpl implements AddressType {
	...
	protected EClass eStaticClass() {
		return AddressBookPackage.Literals.ADDRESS_TYPE;
	}
	...
	public void setCity(String newCity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AddressBookPackage.ADDRESS_TYPE__CITY, oldCity, city));
	}
	...
	public void setZip(String newZip) {
		...
		zip = newZip;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AddressBookPackage.ADDRESS_TYPE__ZIP, oldZip, zip));
	}
	...
	public void setStreet(String newStreet) {
		...
		street = newStreet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AddressBookPackage.ADDRESS_TYPE__STREET, oldStreet, street));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AddressBookPackage.ADDRESS_TYPE__ID, oldId, id));
	}
