...
public class AddressBookSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AddressBookPackage.ADDRESS_BOOK_TYPE: {
				AddressBookType addressBookType = (AddressBookType)theEObject;
				T result = caseAddressBookType(addressBookType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AddressBookPackage.PERSON_TYPE: {
				PersonType personType = (PersonType)theEObject;
				T result = casePersonType(personType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AddressBookPackage.ORGANIZATION_TYPE: {
	 ...
	 * @generated
	 */
	public T caseAddressBookType(AddressBookType object) {
		return null;
	}
