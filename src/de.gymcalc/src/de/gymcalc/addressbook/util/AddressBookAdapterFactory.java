 ...
 * $Id$
 */
package de.gymcalc.addressbook.util;
...
public class AddressBookAdapterFactory extends AdapterFactoryImpl {
	...
	protected AddressBookSwitch<Adapter> modelSwitch =
		new AddressBookSwitch<Adapter>() {
			@Override
			public Adapter caseAddressBookType(AddressBookType object) {
				return createAddressBookTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.gymcalc.addressbook.AddressBookType <em>Type</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.gymcalc.addressbook.PersonType <em>Person Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.gymcalc.addressbook.OrganizationType <em>Organization Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.gymcalc.addressbook.AddressType <em>Address Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
