...
/**
 * This is the item provider adapter for a {@link de.gymcalc.exercise.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_group_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_group_feature", "_UI_Element_type"),
				 ExercisePackage.Literals.ELEMENT__GROUP,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExercisePackage.Literals.ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDifficultyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_difficulty_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_difficulty_feature", "_UI_Element_type"),
				 ExercisePackage.Literals.ELEMENT__DIFFICULTY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExercisePackage.Literals.ELEMENT__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
