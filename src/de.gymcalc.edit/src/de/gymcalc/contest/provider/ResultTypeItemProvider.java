...
/**
 * This is the item provider adapter for a {@link de.gymcalc.contest.ResultType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResultTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResultType_rank_feature"),
				 getString("_UI_ResultType_rank_description"),
				 ContestPackage.Literals.RESULT_TYPE__RANK,
				 true,
				 false,
				 false,
	...
	protected void addPointsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResultType_points_feature"),
				 getString("_UI_ResultType_points_description"),
				 ContestPackage.Literals.RESULT_TYPE__POINTS,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ContestPackage.Literals.RESULT_TYPE__JURIRESULT);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_ResultType_type") + " " + resultType.getRank();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ContestPackage.Literals.RESULT_TYPE__JURIRESULT,
				 ContestFactory.eINSTANCE.createJuriResultType()));

		newChildDescriptors.add
			(createChildParameter
				(ContestPackage.Literals.RESULT_TYPE__JURIRESULT,
				 ContestFactory.eINSTANCE.createTeamJuriResultType()));
	}
